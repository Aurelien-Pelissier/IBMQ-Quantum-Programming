...
Because the implementation of controlled modular exponentiation and inverse QFT are too difficult in the general case, only a special case is implemented as a proof of concept, and the subroutne has been coded for *N=15* and *a* = 7. The non controlled gate *U7* can be omplemented as follow [4]:
