...
The trickiest part is the implementation of the controlled quatum modular exponentiation *U*. A more complete description is available on the [IBM User Guide](https://quantumexperience.ng.bluemix.net/proxy/tutorial/full-user-guide/004-Quantum_Algorithms/110-Shor's_algorithm.html).
